...
public class ExtractorDriver extends DriverBase
{
    @Override
    ...
    {
        return TileEntityGeneExtractor.class;
    }

    public static final class Environment extends ManagedTileEntityEnvironment<TileEntityGeneExtractor>
    {

        public Environment(TileEntityGeneExtractor tileEntity, String name)
        {
